...
public class Pentagonal {
    public void PentagonalLeftNeigbourhood(int i, int j, Embryo embryos[][], Embryo embryos2[][]){
    ...
    public void PentagonalRightNeigbourhood(int i, int j, Embryo embryos[][], Embryo embryos2[][]){
        Map<Color, Integer> map = new HashMap<>();
        Color color;
        int count = 1;
        {
    ...
    public void PentagonalTopNeigbourhood(int i, int j, Embryo embryos[][], Embryo embryos2[][]){
        Map<Color, Integer> map = new HashMap<>();
        Color color;
        int count = 1;
        {
    ...
    public void PentagonalBottomNeigbourhood(int i, int j, Embryo embryos[][], Embryo embryos2[][]){
        Map<Color, Integer> map = new HashMap<>();
        Color color;
        int count = 1;
        {
